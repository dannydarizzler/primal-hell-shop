...
const IMG = {
  ...
  kingtitan: '/images/items/extinction.jpg',
  mastercontroller: '/images/items/mastercontroller.jpg',
...
const CHESTS = {
  tier1: {
    ...
    pool: [
      ...
      { name: 'Manticore Ascension (+15 Levels)', emoji: '🦁', image: IMG.manticore, weight: 5 },
      { name: 'Overseer Ascension (+15 Levels)', emoji: '👁️', image: IMG.overseer, weight: 5 },
      { name: 'Rockwell Ascension (+15 Levels)', emoji: '🧟', image: IMG.rockwell, weight: 5 },
      { name: 'Rockwell Gen2 Ascension (+15 Levels)', emoji: '💜', image: IMG.rockwellGen2, weight: 5 },
      { name: 'Kingtitan Ascension (+15 Levels)', emoji: '☠️', image: IMG.kingtitan, weight: 5 },
      { name: 'Mastercontroller Ascension (+15 Levels)', emoji: '🟣', image: IMG.mastercontroller, weight: 5 },
  ...
  tier2: {
    ...
    pool: [
      ...
      { name: 'Manticore Ascension (+15 Levels)', emoji: '🦁', image: IMG.manticore, weight: 6 },
      { name: 'Overseer Ascension (+15 Levels)', emoji: '👁️', image: IMG.overseer, weight: 6 },
      { name: 'Rockwell Ascension (+15 Levels)', emoji: '🧟', image: IMG.rockwell, weight: 6 },
      { name: 'Rockwell Gen2 Ascension (+15 Levels)', emoji: '💜', image: IMG.rockwellGen2, weight: 6 },
      { name: 'Kingtitan Ascension (+15 Levels)', emoji: '☠️', image: IMG.kingtitan, weight: 6 },
      { name: 'Mastercontroller Ascension (+15 Levels)', emoji: '🟣', image: IMG.mastercontroller, weight: 6 },
